...
// We need to set the files for xoTypescriptConfigs first ruleset to ts files only because
// its currently set to run on js files as well, but we haven't configured ts import to work on js files
// See https://github.com/xojs/eslint-config-xo-typescript/issues/88
xoTypeScript[0].files = [`**/*.{${typescriptExtensions.join(",")}}`];
